...
class __TwigTemplate_5a7299eedb1a126cd50cf1c3801b451031e00856958552b74f75fb60e733e2bb extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <form action=\"";
    ...
    <div class=\"btn-group\">
      <button class=\"btn btn-link dropdown-toggle\" data-toggle=\"dropdown\" style=\"cursor: pointer;\">
      ";
            // line 6
      ...
      ";
            ...
            // line 11
            echo "      <span class=\"hidden-xs hidden-sm hidden-md title-language\">";
      ...
      <ul class=\"dropdown-menu\" >
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
                // line 14
                echo "        <li>
          <button class=\"btn btn-link btn-block language-select title-language\" type=\"button\" name=\"";
                // line 15
                echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 15);
                echo "\" style=\"cursor: pointer;\"><img src=\"catalog/language/";
                echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 15);
                echo "/";
                echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 15);
                echo ".png\" alt=\"";
